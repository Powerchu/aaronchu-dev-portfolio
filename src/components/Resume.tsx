    ...
    return (
        <section id="resume" className="py-20 bg-gray-100 dark:bg-gray-800">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white">Resume</h2>
                <div className="mt-10">
                ...
                <div className="mt-10">
                    <h3 className="text-2xl font-semibold text-gray-700 dark:text-gray-300">Skills</h3>
                    <ul className="list-disc list-inside mt-2">
